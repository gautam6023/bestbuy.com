...
import './cart.css'
export const CartCard = ({price,discount,tax,orderTotal}) => {
  return (
     <>
   ...
   <th className="tableLeft">Estimated Taxes</th><td>{tax}</td></tr></tbody><tfoot><tr className="total">
          <th>Estimated Total</th>
       <td>{orderTotal}</td></tr></tfoot></table>
            </div>
<div>
