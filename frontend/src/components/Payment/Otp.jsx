...
.mainbody {  
    ...
    line-height:2;  
    letter-spacing: 1.5;  
    background-image: url("https://media.istockphoto.com/vectors/online-pay-electronic-bill-payment-mobile-banking-app-and-payment-by-vector-id1307223582?k=20&m=1307223582&s=612x612&w=0&h=PxZ6jOdQ1IMkfv3hGFkyFZ2Q1ODuePRPUuId-V-LZlY=");  
  ...
  return (  
    <Optstyle>  
        ...
        <div className='payment-sec'>  
             ...
             <Link to="" className='button-sec' onClick={handleshow}>Submit</Link>  
             <Link to="/" className='button-sec'>Home</Link>  
             </form>           </div>  
  
        <Dialog show={show}  onhide={handlehide} aria-labelledby="alert-dialog-title"  aria-describedby="alert-dialog-description" >  
